 ...
 * Follows Blibli BLUE design language with search filter, clear button, and accessible options.
 */
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${error ? 'var(--red-500)' : isOpen ? 'var(--blue-500)' : 'var(--border-color)'}`,
          borderRadius: '8px',
